...
3. Configuration:
   ...
   - Region: Same as your Lambda (e.g., us-west-2)
...
2. Copy your **Invoke URL** (looks like: `https://abc123xyz.execute-api.us-west-2.amazonaws.com`)
...
const response = await fetch('https://YOUR-API-ID.execute-api.us-west-2.amazonaws.com/chat', {
```
...
4. Copy the **Bucket website endpoint** (looks like: `http://twin-frontend-xxx.s3-website-us-west-2.amazonaws.com`)
...
4. **Step 2 - Add origin:**
   ...
   - Origin domain name: Paste your S3 website endpoint WITHOUT the http://
     - Example: `twin-frontend-xxx.s3-website-us-west-2.amazonaws.com`
